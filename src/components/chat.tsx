  ...
  return (
    ...
    >
      {messages.map((message: Message, index: number) => (
        <div
          className={`flex flex-col px-4 whitespace-pre-wrap ${message.role !== 'user' ? 'bg-accent border text-accent-foreground dark:text-muted-foreground py-4 rounded-2xl gap-4 w-full' : 'bg-accent dark:bg-neutral-950 py-2 rounded-xl gap-2 w-fit'} font-serif`}
          key={index}
        >
